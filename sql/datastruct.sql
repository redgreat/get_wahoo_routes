...
-- 设置查询路径
alter role user_wahoo set search_path to wahoo, public;
...
alter table workout_info owner to user_wahoo;
...
alter table workout_summary owner to user_wahoo;
...
alter table workout_fits owner to user_wahoo;
